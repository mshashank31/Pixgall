...
echo "<center><font face='Verdana' size='2' ><br>Welcome $_SESSION[userid] Click <a href=logout.php>Logout</a> &nbsp; | &nbsp; <a href=change-password.php>Change Password</a>| &nbsp; <a href=update-profile.php>Update Profile</a><br></center></font>";
echo mysql_error();}
else{
